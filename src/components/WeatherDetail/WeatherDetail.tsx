...
const WeatherDetail = memo<WeatherDetailProps>(({ weather, className = "" }) => {
    ...
    return (
      <div className={`${styles.container} ${className}`}>
        <div className={styles.noData}>
          <FontAwesomeIcon icon={faLocationDot} className={styles.noDataIcon} />
  ...
  return (
    <div className={`${styles.container} ${className}`} role="region" aria-label="Información del clima">
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.currentWeather} aria-label="Clima actual">
          ...
          <div className={styles.temperatureContainer}>
            ...
            <p className={styles.description} aria-label="Descripción del clima">
        ...
        <section className={styles.details} aria-label="Detalles del clima">
          ...
          <WeatherInfoItem
            icon={faWind}
            label="Viento"
            value={`${getWindDirection(weather.wind.deg)} (${windSpeedKmH(weather.wind.speed)} km/h)`}
        ...
        <section className={styles.temperatureRange} aria-label="Rango de temperaturas">
